<?php
/**
 * Yiimp2 Local Development Configuration
 * 
 * This configuration is for local development without Docker.
 * Adjust the database settings to match your local MySQL setup.
 */

ini_set('date.timezone', 'UTC');

define('YAAMP_LOGS', __DIR__ . '/../../log');
define('YAAMP_HTDOCS', __DIR__ . '/../../web');
define('YAAMP_BIN', __DIR__ . '/../../bin');

// Local Database Configuration
// Adjust these settings to match your local MySQL setup
define('YAAMP_DBHOST', 'localhost');
define('YAAMP_DBNAME', 'yaamp');
define('YAAMP_DBUSER', 'root');
define('YAAMP_DBPASSWORD', '');

// Disable Memcache for local development (use file cache instead)
// define('YIIMP_MEMCACHE_HOST', '');
// define('YIIMP_MEMCACHE_PORT', 11211);

define('YAAMP_SITE_URL', 'localhost:8080');
define('YAAMP_STRATUM_URL', YAAMP_SITE_URL);
define('YAAMP_SITE_NAME', 'Yiimp2 Mining Pool - Local Dev');
